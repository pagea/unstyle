...
d.docExtract
d.docExtract()
d2 = DocumentExtractor(Basic9Extractor(), "./datasets/C50train/MichaelConnor/22201newsML.txt")
d2.docExtract()
...
d = DocumentExtractor(Basic9Extractor(), loadAuthorDocs("./datasets/C50train/WilliamKazer/"))
d.docExtract()
