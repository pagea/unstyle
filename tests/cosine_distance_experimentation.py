...
cosine_distance(np.asmatrix([[1.29], [9.92]]), np.asmatrix([[8.21], [2.98]]))
cosine_distance(np.asmatrix([1.29], [9.92]), np.asmatrix([8.21], [2.98]))
cosine_distance(np.asmatrix([[1.29], [9.92]]), np.asmatrix(
    [[8.21], [2.98]], [[2.3], [2.5]]))
...
corpuslabels=["doc", "docs1", "docs2", "docs3",
    "docs4", "auth1", "auth2", "auth3", "auth4"]
corpuslabels
chargrams
chargrams.shape
corpuslabels
...
docsmean.mean()
docsmean = np.array(
    [chargrams[:, 1], chargrams[:, 2], chargrams[:, 3], chargrams[:, 4]])
docsmean
docsmean.mean()
docsmean
chargrams
...
for x, y in combinations(range(1, 5), 2):
    delta_array=np.hstack(
        delta_array, distance.cosine(chargrams[x], chargrams[y]))
